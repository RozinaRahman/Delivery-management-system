...
export const OrderSummary = [
    {
        ...
        value: 3,
        tooltipText:
            'Total sum of parcels that have been created and picked up by shoroksheba',
    },
    {
        id: 2,
...
export const PaymentSummary = [
    {
        id: 1,
        labelText: 'Total sales using shoroksheba',
        value: 'Tk. 13219.00',
        tooltipText:
            'Sum of all the cash collection amount of the parcels that have been picked up by shoroksheba',
    },
    {
        id: 2,
        ...
        value: 'Tk. 2996.80',
        tooltipText:
            'Total delivery charge of all the parcels that have been picked up by shoroksheba',
    },
    {
        id: 3,
